...
LegTrap::LegTrap(float x, float y, float radius)
    : TrapObject(x, y, TrapType::LegTrap), radius(radius) {
...
void LegTrap::Update(const Player& player, float delta_second) {
...
void LegTrap::Draw() const {
    ...
    unsigned int color = detected ? GetColor(255, 0, 0) : GetColor(0, 255, 0);
